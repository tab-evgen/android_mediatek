...
const HI704_SENSOR_INIT_INFO HI704_Initial_Setting_Info[] =
{
    ...
    {0x11, 0x93},   //For No Fixed Framerate Bit[2]//fuzr1 2013-1-23 modifiy 0x90 to 0x93 for 1618 fuzr1 2013-3-4 modify for bug 7753 and also should change the 180 in hal side //fuzr1:2013-3-6rollback it would cause the 3rd sideeffect
    {0x12, 0x04},  //PCLK INV
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_UYVY; //SENSOR_OUTPUT_FORMAT_YVYU;
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
        ...
        HI704_write_cmos_sensor(0x84, 0x14);
        HI704_write_cmos_sensor(0x85, 0x59);
        HI704_write_cmos_sensor(0x86, 0x14);				
