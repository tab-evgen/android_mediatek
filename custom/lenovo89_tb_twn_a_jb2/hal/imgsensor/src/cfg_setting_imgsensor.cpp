...
getSensorOrientation()
{
    static SensorOrientation_T const inst = {
        ...
        u4Degree_1  : 90,    //  sub  sensor in degree (0, 90, 180, 270) fuzr1 2013-3-4 modify for bug 7753 change to 270 and the kernel side also should change to rotate 180 //fuzr1 2013-3-6 rollback for 3rd camera apk side effect
